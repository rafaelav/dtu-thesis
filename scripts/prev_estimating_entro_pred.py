...
def generate_measurements_and_save_results():
    statistics_missing_data = dict()
    statistics_missing_data[10] = []
    statistics_missing_data[30] = []
    statistics_missing_data[50] = []
    statistics_missing_data[70] = []
    statistics_missing_data[80] = []
    for user in user_list:
        ...
        if q<= 0.1:
            statistics_missing_data[10].append(user)
        elif q<0.3:
            statistics_missing_data[30].append(user)
        elif q<0.5:
            statistics_missing_data[50].append(user)
        elif q<0.7:
            statistics_missing_data[70].append(user)
        else:
            statistics_missing_data[80].append(user)
        #if q < 0.8:
    print(statistics_missing_data)
"""
